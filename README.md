...
![Dataflow1](dataflow1.png  "Dataflow")
...
Lexid is now defined as __the 1-based index of the sense__ in the lexicographer file.

The range is now not limited to [0-15] and can exceed it.

The __0 index__ is reserved to mean '*all senses*' in some contexts (likewise 0 means '*all members*' in some contexts).
